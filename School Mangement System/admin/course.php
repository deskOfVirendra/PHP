...
<table cellpadding="0" cellspacing="0"> 
  <tr>
  <td colspan="2"><img  src="images/banner.gif" width="1050" height="168"></td> 
  </tr> 
...
mysql_select_db("darphalc_school",$db);


              
$sql = "UPDATE standard SET standard_name='$_GET[standard_name]',intake='$_GET[intake]',fees='$_GET[fees]'
		 WHERE id='$_GET[id]'";
...
{
  $db = mysql_connect("localhost", "root","");
  mysql_select_db("_school",$db);
$sql = "DELETE from standard WHERE id='$_GET[id]'";
$result = mysql_query($sql);
}

$db = mysql_connect("localhost", "root","");

mysql_select_db("darphalc_school") or die(" could not connect to DB");
...
?>						
    							...
    							<tr align="center">
					  			<form  name="course"method="get" action="<?php echo $_SERVER['PHP_SELF'];?>">
 								<td></td>
								<input class="textbox1" type="hidden" name="id" value="<?php printf($row['id']); ?>">
			<td bgcolor="#DDDDDD">
      <input type="Text" class="textbox1" name="standard_name" size="35" value="<?php printf($row['standard_name']); ?>">							  </td> 
                              <td bgcolor="#DDDDDD">
              <input type="Text" class="textbox1" name="intake"  size="5"value="<?php printf($row['intake']); ?>"></td> 
                              
                              <td bgcolor="#DDDDDD">
             <input type="Text" class="textbox1" name="fees" size="15" value="<?php printf($row['fees']); ?>"> </td>
		<td bgcolor="#DDDDDD"><font face="verdana" style="font-size:12px"></font> 

    <input type="submit" src="images/update.gif" name="update" value="update"></td> 
...
<table width="95%"  border="0" cellspacing="2" cellpadding="1"> 
  <tr> 
    <td height="26" align="center" valign="bottom"><div align="center">&copy;PICT,Pune </div></td>
	</tr> 
</table> 
