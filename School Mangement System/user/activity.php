...
<table width="160" border="0" cellspacing="0" cellpadding="0">  <tr> 
                      ...
                      <table width="100%" cellpadding="0" cellspacing="0"> 
						...
						<td width="2%">&nbsp;</td>
                          <td height="90"class="maintaxt"><ul> 
                                  ...
                                  <li class="style1"> 
                                    ...
                                    Authorized intake of 50 cadets is available with the school.</div> 
                                  </li> 
                                  <li class="style1"> 
                                    <div align="justify" class="paragraph">
                                    Annual camps of 12 day duration, twice in a year during January &amp; June/July, within Gujarat are organized.</div> 
                                  </li> 
                                  <li class="style1"> 
						...
						<tr> 
         				<td width="2%">&nbsp;</td>
						  ...
						  <ul> 
                                    <li class="style1"> 
                                      <div align="justify" class="paragraph">
                                      Multiple competition and debate are organized once in a 
                                      Semester and prizes are given to first and second winners.</div> 
                                    </li> 
                                    <li class="style1"> 
                                      <div align="justify" class="paragraph">
                                      Students can participate in science exhibitions way of presenting modes,
                                       charts etc., When &amp; Where ever it is organized and winners are given prizes.</div> 
                                    </li> 
                                    <li class="style1"> 
                                      <div align="justify" class="paragraph">
                                      Campus has retained and increased its green cover by way of tree - plantation 
                                      programs with the help of state forest department.</div> 
                                    </li> 
                                    <li class="style1"> 
                                      <div align="justify" class="paragraph">Under the head of the Students&rsquo;
                                       various extra curricular activities like Sports , Quiz,
                                        Celebration of National Days Annual function, Nature Camp, and 
                                         Tests for all students are carried out.
                                          The deserving students who have shown their exception even in their 
                                          study are felicitated with the memento and certificates.                                        </div> 
                                    </li> 
                                </ul>
							</td>              
							<td width="2%">&nbsp;</td>
						...
						<td width="2%">&nbsp;</td>
						  ...
						  <ul> 
                                    <li class="style1"> 
                                      <div align="justify" class="paragraph"> 
                                          This cell provides carrier guidance 
                                          as well as any type of carrier related guidance to students.</div> 
                                    </li> 
                                    <li class="style1"> 
                                      <div align="justify" class="paragraph"> 
                                          If you are a sports enthusiast, the school 
                                          has indoor and outdoor sports facilities.
                                           The institute organizes cricket competition, football Competition, 
                                           100 mts. running competition, chess competition etc. once in year.</div> 
                                    </li> 
                                    <li class="style1"> 
                                      <div align="justify" class="paragraph"> 
                                    ...
                                    <li class="style1"> 
                                      <div align="justify" class="paragraph"> 
                                          Nature camp is also organized once in a year,
                                           sometimes sponsored by some well known organization like LIONS CLUB.</div> 
                                    </li> 
                                    <li class="style1"> 
                                      <div align="justify" class="paragraph">  We are forming groups of students and  is also functioning at this
                                       Institute since 2001.   </div> 
                                    </li> 
                                    </ul>
							</td>              
   		 				<td width="2%">&nbsp;</td>
  ...
  <tr> 
    <td height="26" align="center" valign="bottom">&copy; PICT,Pune</td>
	</tr> 
