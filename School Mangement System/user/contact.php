                                    ...
                                    <TD CLASS="normal" ALIGN="center" VALIGN="top"> 
                                        ...
                                        <TABLE ID="table10" BORDER="0" CELLPADDING="1" CELLSPACING="1" WIDTH="502"> 
                                          ...
                                          <TR class="lgbg"> 
                                            ...
                                            <TD CLASS="normal" HEIGHT="23"><font size="-1">PICT,</font></TD> 
                                          </TR> 
                                          <TR class="gbg"> 
                                            <TD CLASS="fheader" ALIGN="right">&nbsp;</TD> 
                                           <TD CLASS="normal" HEIGHT="23"><font size="-1">dhankawadi,</font></TD> 
                                          </TR> 
                                          <TR class="lgbg"> 
                                            <TD CLASS="fheader" ALIGN="right">&nbsp;</TD> 
                                            <TD CLASS="normal" HEIGHT="23"><font size="-1">Pune-413 412. </font></TD> 
                                          </TR> 
                                          <TR class="gbg"> 
                                            <TD CLASS="fheader" ALIGN="right"><strong>&nbsp;&nbsp;&nbsp;</strong></TD> 
                                            <TD CLASS="normal" HEIGHT="23"><font size="-1">Maharashtra</font></TD> 
                                          </TR> 
                                           <TR class="lgbg"> 
                                            ...
                                            <TD HEIGHT="24" CLASS="normal"><font size="-1">+91 02472 240654 </font></TD> 
                                          </TR> 
                                          <TR class="gbg"> 
                                          ...
                                          <TR class="lgbg"> 
                                            ...
                                            <TD CLASS="normal" HEIGHT="24"> <A  HREF="mailto:principal_pict@gmail.com"> <font size="-1">principal_pict@gmail.com</font></A></TD> 
                                          </TR> 
										  <TR class="gbg"> 
                                            ...
                                            <TD CLASS="normal" HEIGHT="24"> <A  HREF="http://www.pict.edu" target="_blank"><font size="-1">www.pict.edu</font></A></TD> 
                                          </TR> 
										   <TR class="lgbg"> 
                                            ...
                                            <TD CLASS="normal" HEIGHT="24"> <A  HREF="" target="_blank"><font size="-1">satellite view on google map</font></A></TD> 
                                          </TR> 
								      </TABLE>
								    </TD>
										  </TR>
