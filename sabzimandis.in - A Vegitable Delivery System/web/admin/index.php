...
<div class="blankpage-main" style="box-shadow: none;">
  ...
  <div class="col-md-4 market-update-gd">
    <a href="addproduct.php">   <div class="market-update-block clr-block-1">
    ...
    <div class="col-md-4 market-update-gd">
        <a href="addcategory.php">  <div class="market-update-block clr-block-1">
          <div class="col-md-8 market-update-left">
      ...
      <div class="col-md-4 market-update-gd">
          <a href="addcity.php">  <div class="market-update-block clr-block-1">
            <div class="col-md-8 market-update-left">
            <h3>Manage City</h3>
            </div>
            <div class="col-md-4 market-update-right">
            ...
            <div class="clearfix"> </div>
                  ...
                  <div class="col-md-4 market-update-gd">
                        <a href="users.php"><div class="market-update-block clr-block-1">
                        <div class="col-md-8 market-update-left">
                        <h3>Manage users</h3>
                    ...
                    <div class="col-md-4 market-update-gd">
                          <a href="editproducts.php"><div class="market-update-block clr-block-1">
                          <div class="col-md-8 market-update-left">
