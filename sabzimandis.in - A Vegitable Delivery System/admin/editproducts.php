...
if(mysqli_num_rows($result2)>0){
             while($row2=mysqli_fetch_assoc($result2)){
                  ...
                  echo "<h3><a href='editproducts.php?cityname=$productname'>$productname</a></h3></br>";
        }
}
?>
...
<div class="style-block" style="min-width:100%;">
  ...
  $select ="SELECT * FROM products where city LIKE '%$cityname%'";
  ...
  ?>
    ...
    text-align: center;margin:0.5px;">
      <div class="content_box"><a href="../details.php?id=<?php echo $id;?>" >
          ...
          <h4><?php echo $productname; ?> (<?php echo $city; ?>)</h4></br>
           <h5><?php echo $brandname;?></h5>
         <div class="grid_1 simpleCart_shelfItem" >

         <div class="item_add"><span class="item_price"><h6>ONLY <?php echo $price;?></h6></span></div>
        <div class="item_add"><span class="item_price"><a href="updateproduct.php?id=<?php echo $id;?>"  onclick="return confirm('Are you sure you want to edit?')">Edit</a></span></div>
          <div class="item_add"><span class="item_price"><a href="deleteproduct.php?id=<?php echo $id;?>"  onclick="return confirm('Delete This Product?')">Delete</a></span></div>
         </div>
        </div>
    </div>
  <?php                 }
