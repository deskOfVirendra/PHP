  ...
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <div>
      <label> Other Language
        <input placeholder="productname in other languages" name="newname" type="text" tabindex="3"  >
      </label>
    </div>
    <div>
      <label>Providername
        <input placeholder="Providername" type="text" name="brandname" tabindex="3" required>
      </label>
    </div>
    <div>
      <label>Original Cost
        ...
        if(mysqli_num_rows($result1)>0){
                     while($row1=mysqli_fetch_assoc($result1)){
                      ...
                      $cityname=$row1['city'];
                          ...
                          echo "  <option value='$productname'>$productname ($cityname)</option>";
    ...
    <div>
      <label>Description
        <textarea placeholder="Description" type="text" name="desc" rows=10 cols=5 ></textarea>
      </label>
    </div>
    <div>
      <label>image 1
