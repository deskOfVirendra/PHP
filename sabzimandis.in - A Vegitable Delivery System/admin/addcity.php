...
$sql = "INSERT INTO cities (city)
                ...
                if ($conn->query($sql) === TRUE) {
                    $error= "New city added successfully";
                } else {
...
if(isset($_GET['delete'])){
      $delete=$_GET['delete'];
      $sql1="DELETE  FROM cities WHERE city='$delete'";
...
<h4><center><?php if(isset($error)) echo $error;?></center></h4>
...
<h4><center>Cities</center></h4>
  ...
  echo "<tr>";
                  ...
                  echo "<td><a href='addcity.php?delete=$row[city]'>" ."delete". "</td>";
