...
$sql = "INSERT INTO products (productName, brandname, price,productDetails,image1,image2,image3,image4,category,productFor,addedOn)



                VALUES ('$productname','$brandname', '$price','$desc','$target1','$target2','$target3','$target4','$category','$productfor','$date')";
...
>
        ...
        <div>
          ...
          <label>
            ...
            <input placeholder="Brand" type="text" name="brandname" tabindex="3" required>
  	...
  	<div>
          ...
          <label>
            ...
            <input placeholder="productFor" type="text" name="productfor" tabindex="3" required>
        ...
        <div>
					...
					<label>
						...
						<textarea placeholder="Description" type="text" name="desc" rows=5 cols=60 required></textarea>
