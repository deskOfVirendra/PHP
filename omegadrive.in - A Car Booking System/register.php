...
else
{
  ...
  $sql = "INSERT INTO users (name,username, password, email,mobile,city)
                  VALUES ('$name', '$user', '$pass','$email','$mobile','$city')";
...
<center>
	<div class="container py-lg-5">
		<h1 class="heading text-capitalize text-center">Registration</h1>
					...
					<div class="modal-body" style="background:#000000;">
						<form action="" method="post">
							...
							<div class="form-group">
								...
								<input type="password" class="form-control" placeholder="Confirm Password" name="cpass" id="password2" required="">
							</div>
							<div class="sub-w3l">
								<div class="sub-agile">
