				...
				<div class="book-agileinfo-form">
					<form action="#" method="post">
						...
						<div class="row main-agile-sectns" style="padding:2px 15px;">
							 ...
							 <input type="radio" name="direction"id="oneway" onclick="showall()" value="oneway">
							 <label >One Way</label></br>
							 <input type="radio" onclick="dontshowdrop()" id="return" name="direction" value="return">
							 <label >Return</label><br>

					 </div>
						<div class="row main-agile-sectns">
							<div class="col-md-6 agileits-btm-spc form-text1">
								<input type="text" name="Pick-up Location" id="pickuplocation" placeholder="Pick-up Location" required="">
							</div>
							<div class="col-md-6 agileits-btm-spc form-text2">
								<input type="text" name="Drop-off Location" id="droplocation" placeholder="Drop-off Location" >
							</div>
						</div>
