...
<html lang="en">
<head>
	<style>#map{ width:380px; height: 500px; }</style>
...
<body>
	...
	if (isset($_GET['submit'])) {
				...
				setcookie("lat2",$_GET['lat2'],time()+86400*24);
				setcookie("long2",$_GET['long2'],time()+24*86400);
	...
	<script>
	  ...
	  function initMap() {
	    var mapOptions = {
	      center: new google.maps.LatLng(18.240098612870256, 76.03497706968571),
	      zoom: 13,
...
<section class="contact py-5">
	<div class="container py-lg-5">
		<h1 class="heading text-capitalize text-center">Select Droping Location</h1>
			...
			<div class="col-md-6 contact-form-left map">
				...
				<div class="book-agileinfo-form">
					<div id="map-canvas" style="height: 380px">
				                  ...
				                  <input type="hidden" name="lat2" value="18.240098612870256" placeholder="Enter latitudes Of Your Business" id="default_latitude" required/ />
				                  </br></br>
				                  <input type="hidden" name="long2" value="76.03497706968571" placeholder="Enter longitudes Of Your Business" id="default_longitude" required/ />
				                  </br></br>
