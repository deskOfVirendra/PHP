				  ...
				  <div class="single_left">
					<div class="grid images_3_of_2">
						...
						<div class="flex-viewport" style="overflow: hidden; position: relative;"><ul class="slides" style="width: 1200%; transition-duration: 0.6s; transform: translate3d(-864px, 0px, 0px);"><li data-thumb="admin/<?php echo $image;?>" class="clone" aria-hidden="true" style="width: 288px; float: left; display: block;">
								...
								<li data-thumb="admin/<?php echo $image1;?>" class= style="width: 288px; float: left; display: block;">
  ...
  <div class="clearfix"></div>
         ...
         <div class="review">
                 <form action="review.php" method="post" >
                   ...
                   <input type="text" name="paddy" value="" placeholder="Write a review...">
               ...
               <?php    $any =" SELECT * FROM review  where productid='$id'  ;";
                   $result=mysqli_query($conn,$any);
                   if(mysqli_num_rows($result)>0){
                                while($row=mysqli_fetch_assoc($result)){
                                       $productname=$row['user'];
                                      $review=$row['review'];
                                       $id=$row['id'];
                 ?>


<div  style="border-bottom:1px solid #46A049;">
                 <h4 style="color:#46A049;"> <?php echo $productname; ?></h4>

                      <p style="text-align:right;"><?php echo $review; ?></p>
