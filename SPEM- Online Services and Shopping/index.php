...
<center><h3><a href="products.php">Products</a></h3></center>
							<div class="col-md-7 mid-content-top" style="min-width:100%;">

                <div class="grids_of_4">
                  <?php    $select ="SELECT * FROM products where city='$city' LIMIT 8";
            ...
            <center><h3><a href="services.php">Services</a></h3></center>
            							<div class="col-md-7 mid-content-top" style="min-width:100%;">

                            <div class="grids_of_4">
                              <?php    $select ="SELECT * FROM services where city='$city' LIMIT 8";
                                  $result=mysqli_query($conn,$select);
                                  if(mysqli_num_rows($result)>0){
                                               while($row=mysqli_fetch_assoc($result)){
            ...
            <div class="col-md-7 mid-content-top" style="min-width:100%;">
              ...
              <div class="grids_of_4">
                <?php    $select ="SELECT * FROM products LIMIT 8";
                    $result=mysqli_query($conn,$select);
                    if(mysqli_num_rows($result)>0){
                                 while($row=mysqli_fetch_assoc($result)){
                                        $productname=$row['productname'];
                           ...
                           <div class="menu">
									<ul id="menu" >
										<li><a href="index.php"><i class="fa fa-tachometer"></i> <span>Home</span></a></li>
										 ...
										 <li id="menu-academico" ><a href="products.php"><i class="fa fa-file-text-o"></i> <span>All Products</span></a></li>
									<li><a href="services.php"><i class="lnr lnr-pencil"></i> <span>All Services</span></a></li>
			            	<li id="menu-academico" ><a href="checkout.php"><i class="lnr lnr-book"></i> <span>Cart</span></a></li>
									 <li><a href="city.php"><i class="lnr lnr-envelope"></i> <span>Change City</span></a></li>
