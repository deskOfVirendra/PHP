...
<div class="women_main">
	...
	<div class="check">
      ...
      <?php   $sql="SELECT * from cart where user='$user';";
           ...
           while($row=mysqli_fetch_array($result)){
             ...
             <script>$(document).ready(function(c) {
               $('.close1').on('click', function(c){
                 $('.cart-header<?php echo $id;?>').fadeOut('slow', function(c){
                   $('.cart-header<?php echo $id;?>').remove();
                 });
                 });
               });
              </script>
			 <div class="cart-header<?php echo $id;?>">
				 ...
				 <div class="cart-sec simpleCart_shelfItem">
						<div class="cart-item cyc">
							 <img src="admin/<?php echo $img;?>" class="img-responsive" alt="">
						</div>
					   <div class="cart-item-info">
						<h3><a href="#"><?php echo $productname;?></a><span></span></h3>
						<ul class="qty">

						</ul>

							 <div class="delivery">
							 <p>Product Price : Rs.<?php echo $price;?> </p>

							 <div class="clearfix"></div>
				        </div>
                <form action="addtocart.php" method="get">
              <button class="item_price" type="submit" value="<?php echo $id;?>" name="place">Place Order</button>
                  <button class="item_price" type="submit" value="<?php echo $id;?>" name="del">Delete</button>
</form>
             </div>
